...
dot_files[bashrc_profile]="$HOME/.bash_profile"
...
dot_files[symbols.mtml]="$HOME/.symbols/main.mtml"
...
dot_files[nftables.conf]="/etc/nftables.conf"
dot_files[bashrc]="/root/.bashrc"
dot_files[tmux.conf]="/root/.tmux.conf"
dot_files[alacritty.toml]="root/.alacritty.toml"
dot_files[vimrc]="/root/.vim/vimrc"
